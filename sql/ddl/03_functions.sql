...
BEGIN
    ...
    IF NOT v_dostepny THEN
        RAISE EXCEPTION 'Kort jest niedostępny w podanym terminie.';
    END IF;
    ...
    RAISE NOTICE 'Rezerwacja nr % została pomyślnie utworzona. Cena: % PLN.', p_id_rezerwacji, p_cena_calkowita;
END;
$$ LANGUAGE plpgsql;
